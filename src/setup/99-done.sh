...
cs_desc "explicit user, no id_rsa on disk — first ssh opens the unlock window;"
cs_desc "pick how long it stays unlocked, then a whole deploy costs ONE Touch ID"
cs_bar
